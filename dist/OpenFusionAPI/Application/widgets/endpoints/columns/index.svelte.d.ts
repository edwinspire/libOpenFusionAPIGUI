export namespace endpointColumns {
    ...
    namespace rowkey {
        export namespace decorator_8 {
            export { cellCountStatusCode as component };
        }
        export { decorator_8 as decorator };
        let label_12: string;
    ...
    namespace updatedAt {
        export namespace decorator_9 {
            let component_1: import("svelte").Component<{
                value?: any;
        ...
        export { decorator_9 as decorator };
        let label_13: string;
