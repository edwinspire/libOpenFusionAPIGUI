...
<Tab bind:tabs bind:active={active_tab}>
			...
			<table class="table is-bordered is-striped is-hoverable">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<div>
								200 (OK), 201 (Created), 202 (Accepted), 203 (Non-Authoritative Information), 204
								(No Content), 205 (Reset Content), 206 (Partial Content), 207 (Multi-Status), 208
								(Already Reported), 226 (IM Used)
							</div>
						</td>
					</tr>
					...
					<tr class="">
						...
						<td>
							<div>
								...
								(Not Found), 405 (Method Not Allowed), 406 (Not Acceptable), 407 (Proxy
								Authentication Required), 408 (Request Timeout), 409 (Conflict), 410 (Gone), 411
								(Length Required), 412 (Precondition Failed), 413 (Payload Too Large), 414 (URI Too
								Long), 415 (Unsupported Media Type), 416 (Range Not Satisfiable), 417 (Expectation
								Failed), 418 (I'm a teapot), 421 (Misdirected Request), 422 (Unprocessable Entity),
								423 (Locked), 424 (Failed Dependency), 425 (Too Early), 426 (Upgrade Required), 428
								(Precondition Required), 429 (Too Many Requests), 431 (Request Header Fields Too
					...
					<tr class="">
						...
						<td>
							<div>
								...
								Also Negotiates), 507 (Insufficient Storage), 508 (Loop Detected), 510 (Not
	...
	<div style="display: {active_tab == 1 ? 'block' : 'none'};"><Table bind:requestData ></Table></div>
</Tab>
