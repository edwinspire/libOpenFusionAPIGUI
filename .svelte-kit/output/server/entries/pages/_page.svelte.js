import "clsx";
import { v as attr_class, w as bind_props, x as ensure_array_like, y as stringify, z as attr } from "../../chunks/index2.js";
...
function validateBaseUrl$1(baseUrl) {
  try {
...
validateBaseUrl$1(PUBLIC_API_SERVER_HOST);
