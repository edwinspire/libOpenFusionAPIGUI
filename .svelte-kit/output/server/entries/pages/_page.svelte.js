...
const Start_page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<section class="hero is-black is-fullheight her svelte-kjqpmw" data-svelte-h="svelte-hakm90"><div class="hero-body"><div class="container svelte-kjqpmw"><div class="main svelte-kjqpmw"><figure class="image is-128x128"><img${add_attribute("src", logo, 0)}></figure></div> <div class="flame"><h1 class="svelte-kjqpmw"><span class="svelte-kjqpmw">OpenFusionAPI</span></h1></div></div></div> </section>`;
});
